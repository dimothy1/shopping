    ...
    <div class="nav-topbar">
      <div class="container">
        ...
        <div class="topbar-user">
          <a  v-if="judge">{{username}}</a>
          <a href="javascript:;" v-if="!judge" @click="login">登录</a>
          <a href="javascript:;" v-if="judge" @click="logout">退出</a>
    ...
    <div class="nav-header">
      <div class="container">
        ...
        <div class="header-search">
          <div class="wrapper" style="border: #333333" >
